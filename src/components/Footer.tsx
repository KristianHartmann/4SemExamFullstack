...
const Footer: React.FC = () => {
  return (
    <footer className="flex flex-col sm:flex-row justify-between text-white items-center w-full bg-tertiary sm:px-16 font-serif">
      <div className="flex h-10 gap-6 py-2 sm:ml-9">
